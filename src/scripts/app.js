...
import TweenMax from './tweenmax.1.20.3.js';
...
export default class App {
  init() {
    ...
    this.loadModels('https://raw.githubusercontent.com/ca-john/ca-john.github.io/main/homepage_buildings.obj', this.onLoadModelsComplete.bind(this));
    this.animate();
